...
8. 나중에 문의가 오면 **강의 관리 → 히스토리 → 신청자 행 선택**에서 과거 입금/발송/재발송/메모를 확인합니다.
...
발송 성공 시 당시의 실제 제목, 본문, 녹화본 URL, 수신 이메일, 템플릿 이름을 발송로그에 snapshot으로 보존합니다. 이후 템플릿을 수정해도 과거 발송 내용은 바뀌지 않습니다.
